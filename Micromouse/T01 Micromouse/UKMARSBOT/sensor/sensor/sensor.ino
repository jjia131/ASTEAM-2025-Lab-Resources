...
//const int EMITTER = 11;  // for forward sensor IR emitting

const int EMITTER = 12;  // for diagonal sensor IR emitting
...
void loop() {
  if (millis() > updateTime) {
    ...
    //readSensor(A0);   // forward sensor right-hand

   // readSensor(A3);   // forward sensor left-hand

    // readSensor(A1);   // diagonal sensor right-hand

       readSensor(A2);   // diagonal sensor left-hand
